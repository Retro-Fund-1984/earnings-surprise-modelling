...
builtins.__ESURPRISE_SETUP__ = True
...
import esurprise._min_dependencies as min_deps

ver_file = os.path.join("esurprise", "_version.py")
with open(ver_file) as f:
    exec(f.read())

MAINTAINER = "J. Fonseca and A. Bell"
